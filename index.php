						...
						<div class="row">
							...
							<div class="col-10">
								...
								<form action="insert.php" method="GET">
									...
									<input name="twit" class="form-control" placeholder="твит">	
		 							<button class="btn btn-danger">твитнуть</button>
								</form>
							</div>
						</div>
						<!-- новый пост -->
